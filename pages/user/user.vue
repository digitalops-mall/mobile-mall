    ...
    <view class="container">  
		...
		>
			...
			<view class="order-section">
				<view class="order-item" @click="goto('order')" hover-class="common-hover"  :hover-stay-time="50">
					<text class="yticon icon-shouye"></text>
					<text>全部订单</text>
				</view>
				<view class="order-item" @click="goto('cart')"  hover-class="common-hover" :hover-stay-time="50">
					<text class="yticon icon-daifukuan"></text>
					<text>购物车</text>
				</view>
				<view class="order-item" @click="goto('returnGoods')" hover-class="common-hover"  :hover-stay-time="50">
					<text class="yticon icon-shouhoutuikuan"></text>
					<text>申请退货</text>
				</view>
				<view class="order-item" @click="goto('address')" hover-class="common-hover"  :hover-stay-time="50">
		...
		<view class="btn-row" style="display: flex;">
			<button type="primary" class="primary" size="mini" @tap="refreshLogin">刷新登录信息</button>
			<button type="primary" class="primary" size="mini" @tap="logout">退出登录</button>
		</view>	
    ...
    export default {
        ...
        methods: {
			...
			goto(type) {
				switch(type) {
					case 'order':
						this.$mUtils.goto(this.$mRoutesConfig.orderList)
						break;
					case 'cart':
						this.$mUtils.goto(this.$mRoutesConfig.cart)
						break;
					case 'address':
						this.$mUtils.goto(this.$mRoutesConfig.address)
						break;
					case 'returnGoods':
						this.$api.msg('功能暂未开放')
						break;
